...
const tNMEA2000::tProductInformation BatteryMonitorProductInformation PROGMEM = {
  ...
  "00007757",                  // Manufacturer's Model serial code
...
const char BatteryMonitorInstallationDescription1 [] PROGMEM = "Desc 1";
const char BatteryMonitorInstallationDescription2 [] PROGMEM = "Desc 2";
...
/*
  ...
  if ( TempUpdated+BatUpdatePeriod<millis() ) {
    TempUpdated=millis();
    SetN2kDCBatStatus(N2kMsg,1,bank,0,21.18,1);
